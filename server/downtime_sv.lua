function rebootQuinze(d, h, m) 
  TriggerClientEvent('DisplayAd', -1, Config.AdType, _U('text', 15))
end
function rebootDix(d, h, m) 
  TriggerClientEvent('DisplayAd', -1, Config.AdType, _U('text', 10))
end
function rebootCinq(d, h, m) 
  TriggerClientEvent('DisplayAd', -1, Config.AdType, _U('text', 5))
end
